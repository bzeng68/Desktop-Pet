...
def gravity():
    if desktopPetManager.get_y() < window_height - bear_dimension - 48:
...
bear_dimension = 96
desktopPetManager = DesktopPetManager(window_width - bear_dimension - 36, window_height - bear_dimension - 48, False, False)
